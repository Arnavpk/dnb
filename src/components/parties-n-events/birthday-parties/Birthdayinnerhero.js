...
const content = {
    ...
    images: {
        desktop:
            "https://daveandbustersindia.com/wp-content/uploads/2025/04/banner-1.jpg",
        mobile:
            "https://daveandbustersindia.com/wp-content/uploads/2025/04/mobile-banner-1.jpg",
    },
};

// ─── Main Component ───────────────────────────────────────────────────────────
export default function BirthdayInnerHero() {
    return (
        <section className="relative w-full h-[600px] md:h-screen overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 xl:px-8">
                ...
                >
                    {/* Semi-transparent card — rgba(0,0,0,0.5), border-radius: 25px,
              padding: 36px 24px, position: absolute, bottom: 100px, left: 0 */}
                    <div
