...
// ─── Main Component ───────────────────────────────────────────────────────────
export default function PartiesCallout() {
    return (
        <section
            className="py-10"
        // style={{
        ...
        >
            <div className="container mx-auto px-4 xl:px-8">
                {/* Bordered card — matches original border + border-radius-24px + p-50px */}
                <div className="border-none rounded-3xl px-8 py-12 lg:px-12 flex justify-center"
