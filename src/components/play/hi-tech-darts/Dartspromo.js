...
const FALLBACK = {
    ...
    body: "Discover the thrilling world of darts at Dave & Buster's! Whether you're a casual thrower or chasing a bullseye, every game is a blend of skill, challenge, and pure fun.\n\nReady, Set, Throw!",
    // imageSrc: "https://daveandbustersindia.com/wp-content/uploads/2025/04/DARTS.jpg",
    imageAlt: "Man aiming a dart at an electronic dartboard at Dave & Buster's.",
    ctaLabel: "Book Now",
...
export default function DartsPromo({ section }) {
