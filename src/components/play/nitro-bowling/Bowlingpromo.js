...
const FALLBACK = {
    ...
    body: "Step into the future of bowling in Bangalore with Spark®️, where cutting-edge technology meets pure fun! Watch your lanes come alive with mesmerizing visuals, turning every roll into an epic experience.\n\nTomorrow's innovation is here to blow your mind today!",
    // imageSrc: "https://daveandbustersindia.com/wp-content/uploads/2025/04/Bowling.jpg",
    imageAlt: "Person bowling on an interactive lane at Dave & Buster's",
    ctaLabel: "Book Now",
...
export default function BowlingPromo({ section }) {
