...
const content = {
    ...
    body: null, // No body text in this variant — set a string to enable
    cta: {
...
// ─── Main Component ───────────────────────────────────────────────────────────
export default function BowlingPartiesCallout() {
    return (
        <section
            className="py-10"
        // style={{
        ...
        >
            <div className="container mx-auto px-4 xl:px-8">
                {/* Box with orange→pink gradient background — matches .reserve-table-box */}
                <div
