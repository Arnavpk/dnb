...
const FALLBACK = {
    heading: "BOWLING, BUT BETTER",
    // desktopSrc: "https://daveandbustersindia.com/wp-content/uploads/2025/04/Bowlling-Banner-desk.jpg",
    mobileSrc: "https://daveandbustersindia.com/wp-content/uploads/2025/04/Bowlling-Banner-Mob.jpg",
};
...
export default function BowlingInnerHero({ section }) {
        ...
        <section className="relative w-screen h-[600px] md:h-screen overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 xl:px-8">
                <div className="relative w-full md:w-1/2" style={{ minHeight: "clamp(420px, 70vh, 580px)" }}>
                    ...
                    >
                        <h1 className="text-2xl sm:text-3xl md:text-[60px] font-extrabold leading-tight tracking-tight">
                            {heading}
                        </h1>
                    </div>
                </div>
