...
export default function SummerTerms({ location = "bangalore" }) {
    return (
            ...
            <div className="container mx-auto px-4 xl:px-8">
                <div className="flex justify-center">
                    <div className="w-full md:w-8/12 lg:w-7/12">
                        ...
                        {/* T&C Box — bordered like birthday offer */}
                        <div className="rounded-2xl border-2 border-[#ff6f00] px-8 py-8">
                            <h2 className="text-xl md:text-2xl font-extrabold text-[#15189a] uppercase tracking-tight mb-6 text-center font-din">
                                Terms & Conditions
                            </h2>
